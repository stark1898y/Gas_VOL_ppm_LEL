...
可燃气体浓度单位 VOL%、ppm、LEL 之间的换算工具，支持 8 种常见可燃气体，提供 C / Python / 纯前端网页三种实现。

## 在线演示

**GitHub Pages**：[点击访问在线换算工具](https://stark1898y.github.io/Gas_VOL_ppm_LEL/)
...
```bash
cd c
gcc gas_vol_ppm_lel.c -o gas_vol_ppm_lel
./gas_vol_ppm_lel
```
